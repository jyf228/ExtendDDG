...
class ExtendDDG:
    ...
    def detailed_evaluate_description(
        self, generated_description: str, ground_truth: str
    ) -> dict[str, float]:
    ...
    def bert_evaluate_description(
        self, generated_description: str, ground_truth: str, model="bert-base-uncased"
    ) -> dict[str, float]:
    ...
    def rouge_evaluate_description(
        self, generated_description: str, ground_truth: str
    ) -> dict[str, float]:
