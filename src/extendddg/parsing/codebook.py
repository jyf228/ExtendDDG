...
class CodebookParser:
    ...
    def extract_variables(self, codebook_path: str) -> DataFrame:
    ...
    def _extract_from_pdf(self, codebook_path: str) -> DataFrame:
        ...
        raise NotImplementedError("PDF codebook parsing is not implemented yet.")
